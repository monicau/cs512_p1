 ...
 * 
 */
@WebServiceClient(name = "ResourceManagerImplService", targetNamespace = "http://server/", wsdlLocation = "http://Lenny:8080/rm/service?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://Lenny:8080/rm/service?wsdl");
